...
BOOL OnInit(){
	...
	// ローカルフック
	hHook = SetWindowsHookEx(WH_GETMESSAGE, (HOOKPROC)MyHookProc, (HINSTANCE)GetWindowLongPtr(fpi.hParent, GWLP_HINSTANCE), GetWindowThreadProcessId(fpi.hParent, NULL));
