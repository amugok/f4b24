...
void OnPaint(HWND hWnd){
	...
	Gdiplus::GpImage *pimg;
	Gdiplus::GpGraphics *pgp;
	Gdiplus::DllExports::GdipLoadImageFromFile(wstr, &pimg);
	Gdiplus::DllExports::GdipCreateFromHDC(hDC, &pgp);
	Gdiplus::DllExports::GdipDrawImageRectI(pgp, pimg, rc.left, rc.top, width, height);
	Gdiplus::DllExports::GdipDeleteGraphics(pgp);
	Gdiplus::DllExports::GdipDisposeImage(pimg);
...
BOOL OnInit(){
	...
	hOldWndProc = (WNDPROC)SetWindowLongPtr(fpi.hParent, GWLP_WNDPROC, (LONG_PTR)WndProc);
	...
	hPanel = CreateWindowEx(0,
							...
							0);
	hOldPanelProc = (WNDPROC)SetWindowLongPtr(hPanel, GWLP_WNDPROC, (LONG_PTR)PanelProc);
