/*
要 7-zip32.dll/7-zip64.dll/7z.dll文字化け対策版 17.00.00.01
現時点で本家は SevenZipExtrctMem API が実装されていない

7z に対応する

64bit版なら さらに zip に対応する

64bit 7z.dll対応版 なら さらに lzh arj に対応する
...
#if 1
		/* SevenZipExtractMem では dwOutputSize が更新されない可能性がある  */
