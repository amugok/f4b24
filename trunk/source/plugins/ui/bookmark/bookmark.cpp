...
static void LV_SetState(HWND hLV, int nItem, int nState){
		...
		case WM_INITDIALOG:	// 初期化
			{
				...
				LV_SetState(hList, 0, (LVIS_SELECTED | LVIS_FOCUSED));
				...
				case IDC_BUTTON1:	// 上へ
					{
						...
						LV_SetState(hList, nSel-1, (LVIS_SELECTED | LVIS_FOCUSED));
					}
					return TRUE;
